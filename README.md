...
| `FARFALL_RESUME=0` | on | Start at the stock orbit and leave `~/.farfall/world.cfg` alone for this run. Normally the game resumes where you quit (RESUME on the GFX page turns that off; NEW GAME there forgets the world) |
