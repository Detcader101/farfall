...
**Hull sounds** (CABIN page, HULL SOUNDS): space is silent, but the ship is not — under speed the frame creaks and crackles, grains of rock tink off the hull (the faster you go the more you meet; pebbles thud), and the hoops' womp quietens at speed and moulds into a low drone.
