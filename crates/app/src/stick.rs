...
impl StickMap {
    ...
    pub fn reforger_heli() -> Self {
        ...
        Self {
            ...
            fire: Some(0),
            buttons,
            // Reforger's pilot profile has no shift layer, and BASE L
            // carries its map job — only ESC keeps its reserved seat so
            // the menus stay pilotable while this map is worn.
            shift: None,
            back: Some(11),
